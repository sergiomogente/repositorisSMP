...
int cartasuma(int i, int puntos, struct carta mano[])
{
...
int main()
{
    ...
    int opcion;
    bool repetir = true, executar = true;
    ...
    do
    {
        ...
        if (executar)
        {
            ...
            {
                puntos = cartasuma(i, puntos, mano);
            }
            if (calculopuntos(puntos) == false)
            {
                repetir = false;
                break;
            }
        ...
        case 1:
            ...
            puntos = cartasuma(num_cartas_mano, puntos, mano);
            num_cartas_mano++;
            if (calculopuntos(puntos) == false)
            {
                repetir = false;
        ...
        case 3:
            ...
            while (puntosMaquina < puntos)
            {
                ...
                puntosMaquina = cartasuma(i, puntosMaquina, manoMaquina);
